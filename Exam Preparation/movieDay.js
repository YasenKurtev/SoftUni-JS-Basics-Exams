function movieDay(input){
    ...
    let timeOneScene = Number(input[2]);

    let timePrep = timeShooting * 0.15;
    let timeScenes = scenes * timeOneScene;
    let totalTime = timePrep + timeScenes;

    let diff = Math.abs(timeShooting - totalTime);
